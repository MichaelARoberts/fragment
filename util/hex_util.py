...
BUFFSIZE = 1073741824
parser = argparse.ArgumentParser(description="Convert from hex to a string, or vice versa, from a file")
parser.add_argument('-bh', help="Creates hex with proper spacing")
